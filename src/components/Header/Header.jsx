  ...
  return (
    <header className={style()} ref={ref}>
      ...
      <h1 className={style('hello')}>
        <span className={style('heading', { main: true })}>
          <span className={style('heading', { color: true })}>D</span>ora{' '}
          <span className={style('heading', { color: true })}>N</span>ails
        </span>
      ...
      <h2 className={style('contact')}>
        ...
        <a href="tel:+48 123456789" className={style('action')}>
        ...
        <a href="mailto: dora.nails@dnails.pl" className={style('action')}>
